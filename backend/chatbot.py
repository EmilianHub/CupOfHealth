...
for disease in casualDiseases:
    question = [f"Co to jest {disease.choroba}", f"Opisz mi {disease.choroba}", f"Podaj mi opis {disease.choroba}", f"Jakie objawy ma {disease.choroba}", f"Podaj objawy {disease.choroba}"]
    for q in question:
        tokenizedWord = nlp(q)
